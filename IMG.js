...
class IMG{
    ...
    probableEyeCoordinates(skinCoordinates, glassHeight , glassWidth){
        return {
            x:skinCoordinates.x ,
            y: (skinCoordinates.height/3) + skinCoordinates.y ,
            width: skinCoordinates.width,
            height:((skinCoordinates.width-20) * glassWidth) / glassHeight,
        }; 
    }
