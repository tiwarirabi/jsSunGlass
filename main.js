...
let preloadGlass = new Preloader();
preloadGlass.load();

let sunglass = new SunGlass();
...
setInterval(()=>{
        ...
        //let probableEyeCoordinate = videoImage.probableEyeCoordinates(faceCoordinates,sunglass.width,sunglass.height);
        
        let sunglassCoordinate = sunglass.glassCoordinates(faceCoordinates);
        
        videoImage.context.drawImage(sunglass.image,sunglassCoordinate.x,sunglassCoordinate.y,sunglassCoordinate.width,sunglassCoordinate.height);
},250);
